...
from plottr.node.node import Node, NodeWidget, updateGuiQuietly, updateOption
...
class DummyNodeWidget(NodeWidget):
    ...
    def __init__(self, node: Node):
        ...
        self.widget.dimensionSelectionMade.connect(
            lambda x: self.signalOption("selectedAxes")
        )
...
class DummyNode(Node):
    ...
    def process(self, dataIn=None) -> Dict[str, DataDict | None]:
