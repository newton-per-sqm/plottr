...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Script to open apps")
    parser.add_argument(
        "port", help="The port this process should communicate through", default="12345"
    )
    ...
    parser.add_argument(
        ...
        nargs="*",
        default=[
            "/home/msmt/Documents/code_playground/Slider playground/data/manual_data/simple_data.ddh5",
            "data",
        ],
    )
