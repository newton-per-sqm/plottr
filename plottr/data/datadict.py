...
from plottr.utils import misc, num
...
class DataDictBase(dict):
    ...
    def meta_items(
        self, data: str | None = None, clean_keys: bool = True
    ...
    def meta_val(self, key: str, data: str | None = None) -> Any:
        """
    ...
    def add_meta(self, key: str, value: Any, data: str | None = None) -> None:
        """
    ...
    def delete_meta(self, key: str, data: str | None = None) -> None:
        """
    ...
    def clear_meta(self, data: str | None = None) -> None:
        """
    ...
    def structure(
        ...
        remove_data: list[str] | None = None,
    ) -> T | None:
        """
    ...
    def nbytes(self, name: str | None = None) -> int | None:
    ...
    def label(self, name: str) -> str | None:
        ...
        if self.validate():
            if name not in self:
                raise ValueError(f"No field '{name}' present.")
    ...
    def axes(self, data: Sequence[str] | str | None = None) -> list[str]:
        """
    ...
    def reorder_axes(
        self: T, data_names: str | Sequence[str] | None = None, **pos: int
    ) -> T:
        """
        Reorder data axes.
...
class MeshgridDataDict(DataDictBase):
    ...
    def reorder_axes(
        self, data_names: str | Sequence[str] | None = None, **pos: int
    ) -> "MeshgridDataDict":
        """
    ...
    def slice(self, **kwargs: dict[str, slice | int]) -> "MeshgridDataDict":
...
def _mesh_slice(
    data: MeshgridDataDict, **kwargs: dict[str, slice | int]
) -> MeshgridDataDict:
    """Return a N-d slice of the data.
...
def guess_shape_from_datadict(
    data: DataDict,
) -> dict[str, None | tuple[list[str], tuple[int, ...]]]:
    """
...
def datadict_to_meshgrid(
    ...
    inner_axis_order: None | Sequence[str] = None,
...
def combine_datadicts(*dicts: DataDict) -> DataDictBase | DataDict:
    """
...
def datastructure_from_string(description: str) -> DataDict:
    ...
    def analyze_field(df: str) -> tuple[str, str | None, list[str] | None]:
