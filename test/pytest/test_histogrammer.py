...
def test_real_histogram(qtbot):
    ...
    assert fc.outputValues()["dataOut"].axes("noise_count") == ["y", "z", "noise"]
    assert arrays_equal(fc.outputValues()["dataOut"]["noise_count"]["values"], hist)
...
def test_histogram_with_ui(qtbot):
    ...
    assert fc.outputValues()["dataOut"].dependents() == ["noise_count"]
    assert fc.outputValues()["dataOut"].axes("noise_count") == ["x", "z", "noise"]
    assert arrays_equal(fc.outputValues()["dataOut"]["noise_count"]["values"], hist)
